      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="relative">
          <input
            ...
            className="w-full pl-11 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 
              bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder:text-gray-500
