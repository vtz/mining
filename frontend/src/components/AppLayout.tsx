  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
          ...
          <div className={`transition-all duration-300 ${
            ...
            {/* Top Header */}
            <header className="sticky top-0 z-20 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm overflow-visible">
              <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8 overflow-visible">
                {/* Mobile menu button */}
                <button
            ...
            <footer className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 py-4">
              <div className="px-4 sm:px-6 lg:px-8">
                <p className="text-center text-sm text-gray-500 dark:text-gray-400">
                  © 2026 nsreturn.ai • Powered by precision mining economics
                </p>
              </div>
            </footer>
          </div>
